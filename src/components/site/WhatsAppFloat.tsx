      ...
      {show && (
        ...
        >
          <AnimatePresence>
            {open && (
              <motion.div
                ...
                className="w-[300px] rounded-2xl border border-border bg-card shadow-2xl shadow-black/10 overflow-hidden"
              >
          ...
          <button
            ...
            className="relative h-14 w-14 rounded-full bg-[#25D366] text-white shadow-xl shadow-[#25D366]/40 flex items-center justify-center transition-transform hover:scale-105 active:scale-95"
          >
